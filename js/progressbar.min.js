  ...
  })(
    {
            ...
            var e = (function () {
              ...
              function i(a, b, c, d, e, f, g) {
                var h,
                  i = (a - f) / e;
                for (h in b)
                  b.hasOwnProperty(h) && (b[h] = j(c[h], d[h], o[g[h]], i));
                return b;
              }
              function j(a, b, c, d) {
                return a + (b - a) * c(d);
        ...
        function (a, b) {
          var c = a("shifty"),
            ...
            f = function (a, b) {
              ...
              (this._path.style.strokeDasharray = c + " " + c),
                (this._path.style.strokeDashoffset = c);
            };
          (f.prototype.value = function () {
            var a = window.getComputedStyle(this._path, null),
              b = a.getPropertyValue("stroke-dashoffset");
            b = parseFloat(b, 10);
            var c = this._path.getTotalLength(),
              d = 1 - b / c;
            return parseFloat(d.toFixed(10), 10);
          }),
            (f.prototype.set = function (a) {
              this.stop();
              var b = this._path.getTotalLength();
              this._path.style.strokeDashoffset = b - a * b;
            }),
            (f.prototype.stop = function () {
              this._stopTween();
              var a = window.getComputedStyle(this._path, null),
                b = a.getPropertyValue("stroke-dashoffset");
              this._path.style.strokeDashoffset = b;
            }),
            (f.prototype.animate = function (a, b, e) {
              ...
              var j = window.getComputedStyle(this._path, null),
                k = j.getPropertyValue("stroke-dashoffset");
              k = parseFloat(k, 10);
              var l = this._path.getTotalLength(),
                m = l - a * l,
                n = this;
              (this._tweenable = new c()),
                this._tweenable.tween({
                  from: d.extend({ offset: k }, i.from),
                  to: d.extend({ offset: m }, i.to),
                  duration: b.duration,
                  easing: h,
                  step: function (a) {
                    (n._path.style.strokeDashoffset = a.offset),
                      b.step(a, b.attachment);
                  },
                  finish: function (a) {
                    (n._path.style.strokeDashoffset = a.offset),
                      b.step(a, b.attachment),
            ...
            (f.prototype._resolveFromAndTo = function (a, b, d) {
              ...
              var e = c.interpolate(
                ...
                f = c.interpolate(this._opts.from, this._opts.to, a, b);
              return { from: e, to: f };
            }),
      ...
      6: [
        function (a, b) {
          var c = a("./path"),
            ...
            f = "Constructor was called without new keyword",
            g = function h(a, b) {
              if (!(this instanceof h)) throw new Error(f);
              if (0 !== arguments.length) {
                var e,
                  g = this._createSvgView(b);
                (e = d.isString(a) ? document.querySelector(a) : a),
                  e.appendChild(g.svg);
                var i = d.extend({ attachment: this }, b);
                (this._progressPath = new c(g.path, i)),
                  (this.svg = g.svg),
                  (this.path = g.path),
                  (this.trail = g.trail);
              }
          ...
          (g.prototype.animate = function (a, b, c) {
            ...
            (g.prototype._createSvgView = function (a) {
              ...
              var e = this._createPath(a);
              return b.appendChild(e), { svg: b, path: e, trail: c };
            }),
            (g.prototype._initializeSvg = function (a) {
            ...
            (g.prototype._pathString = function () {
              throw new Error("Override this function for each progress bar");
            }),
            (g.prototype._trailString = function () {
              throw new Error("Override this function for each progress bar");
            }),
            (b.exports = g);
        },
      ...
      8: [
        function (a, b) {
          ...
          b.exports = { extend: c, render: d, isString: e, isFunction: f };
        },
        {},
      ],
    },
